...
document.querySelector("#html-card").addEventListener("click", () => {
    ...
    conhecimentoTexto.innerHTML = `"HyperText Markup Language" é uma linguagem de marcação para Desenvolvimento Web, praticamente toda a Web é feita dela. <br><br>5 meses de experiência.`;
})

document.querySelector("#css-card").addEventListener("click", () => {
    conhecimentoTitle.innerHTML = `CSS`;
    conhecimentoTexto.innerHTML = `"Cascading Style Sheets" é uma folha de estilo que completa o HTML, sem ele a WEB que conhecemos hoje seria preto e branco. <br><br>5 meses de experiência.`;
})

document.querySelector("#js-card").addEventListener("click", () => {
    conhecimentoTitle.innerHTML = `JavaScript`;
    conhecimentoTexto.innerHTML = `Enquanto o HTML é o corpo e o CSS é o design da nossa página, o JavaScript vem para ser a funcionalidade dela. Com ele nós podemos fazer inúmeras coisas. <br><br>3 meses de experiência.`;
})
